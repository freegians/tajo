...
<script src="resources/lib/js/jquery.selection.js"></script>
<script src="resources/lib/js/jquery.tabletoCSV.js"></script>
<script src="resources/lib/js/canvg.bundle.min.js"></script>
<script src="resources/lib/js/d3.min.js"></script>
<!--<script th:src="@{/bower_components/nvd3-master/build/nv.d3.min.js}" src="../../static/bower_components/nvd3/build/nv.d3.min.js"></script>-->
<script src="resources/lib/js/nv.d3.min.js"></script>

<!--<link rel="stylesheet" th:href="@{/css/bootstrap.min.css}" href="../../static/css/bootstrap.min.css" />-->
<script src="resources/lib/js/bootbox.js"></script>